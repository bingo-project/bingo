...
require (
	...
	github.com/bingo-project/bingoctl v1.6.3
	github.com/bingo-project/component-base v0.5.1
	github.com/bingo-project/websocket v0.2.2
...
require (
	...
	github.com/cloudwego/eino-ext/components/model/gemini v0.1.21 // indirect
