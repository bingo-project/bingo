...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_bingo-project_bingo_pkg_api_apiserver_v1.LoginByProviderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_bingo-project_bingo_pkg_api_apiserver_v1.LoginByProviderRequest": {
            "type": "object",
            "properties": {
                "code": {
