// Package apiserver Code generated by swaggo/swag. DO NOT EDIT
package apiserver
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/ai/sessions/{session_id}/history": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.SessionHistoryResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.ChatCompletionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.ChatCompletionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.ListModelsResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "v1.ChatCompletionResponse": {
            "type": "object",
            "properties": {
                "choices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.ChatChoice"
                    }
                },
                "created": {
                    "type": "integer"
        ...
        "v1.ListModelsResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.ModelInfo"
                    }
                },
                "object": {
                    "type": "string"
